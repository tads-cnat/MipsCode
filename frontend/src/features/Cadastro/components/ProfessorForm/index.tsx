...
import { Box, TextField, Button, Snackbar, Grid, Link, Typography, Container } from '@mui/material';
  ...
  return (
    <Container component="main" maxWidth="xs">
      <Box sx={{ marginTop: 4, display: 'flex', flexDirection: 'column', alignItems: 'center',}}>      
        ...
        <Box component="form" onSubmit={handleSubmitProfessor} encType="multipart/form-data" sx={{ mt: 3, textAlign: 'center'}}>
